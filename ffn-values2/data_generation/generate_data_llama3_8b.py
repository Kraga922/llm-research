...
def get_preds_and_hidden_states(wiki_text_sentences, model, tokenizer, model_type='llama', device='cuda:0', random_pos=True, batch_size=8):
    if model_type == 'gpt2':
...
def get_examples_df(prompts, model, tokenizer, model_type='llama', device='cuda:0', batch_size=8):
...
def main():
    ...
    parser.add_argument(
        "--output_path", default='model_df_llama3_1_8b_instruct.pkl', type=str, help="Output pickle file path"
    )
    parser.add_argument(
